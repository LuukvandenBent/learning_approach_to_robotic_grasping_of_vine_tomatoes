...
class RqtPipeline(Plugin):
    ...
    def __init__(self, context):
        ...
        self._widget.DetermineGraspCandidatesKeypoints.clicked[bool].connect(lambda: self.send_command_to_pipeline("determine_grasp_candidates_keypoints"))
        ...
        self._widget.ChooseGraspPoseFromCandidatesPointcloud.clicked[bool].connect(lambda: self.send_command_to_pipeline("choose_grasp_pose_from_candidates_pointcloud"))
