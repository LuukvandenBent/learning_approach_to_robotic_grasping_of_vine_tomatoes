...
class Model(nn.Module):
    ...
    def _forward_augment(self, x):
        ...
        s = [1, 1, 1, 0.9, 0.9, 0.9, 1.1, 1.1, 1.1]  # scales
    ...
    def _descale_pred(self, p, flips, scale, img_size):
        ...
        if self.inplace:
            ...
            if flips == 2:
                ...
                p[..., 3] = img_size[0] - p[..., 3]  # de-flip ud
                p[..., 5] = img_size[0] - p[..., 5]  # de-flip ud
                p[..., 7] = img_size[0] - p[..., 7]  # de-flip ud
            elif flips == 3:
                p[..., 0] = img_size[1] - p[..., 0]  # de-flip lr
                p[..., 2] = img_size[1] - p[..., 2]  # de-flip lr
                p[..., 4] = img_size[1] - p[..., 4]  # de-flip lr
                p[..., 6] = img_size[1] - p[..., 6]  # de-flip lr
        else:
            print("SET INPLACE BACK ON OR FIX THIS FUNC #TODO")
